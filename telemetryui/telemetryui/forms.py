...
from wtforms import StringField, SelectField, HiddenField, TextField, SelectMultipleField
...
#    machine_id = HiddenField('Machine ID (autopopulated)', validators=[Regexp('([0-9a-f]+|All)')])
...
class GuiltyEditOneForm(FlaskForm):
    frames = SelectMultipleField(widget=select_multi_checkbox, render_kw={'ul_class':'list-group', 'li_class':'list-group-item'})
